...
SWIFT_CLASS("_TtC6Portal20PortalViewController")
@interface PortalViewController : UIViewController
@property (nonatomic, strong) IBOutlet ARSCNView * _Nullable sceneView;
@property (nonatomic, weak) IBOutlet UILabel * _Nullable messageLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Nullable sessionStateLabel;
...
@interface PortalViewController (SWIFT_EXTENSION(Portal)) <ARSCNViewDelegate>
...
SWIFT_CLASS("_TtC6Portal7RWLabel")
